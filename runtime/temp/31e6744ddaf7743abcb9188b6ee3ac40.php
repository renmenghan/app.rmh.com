  ...
  <form class="form form-horizontal" id="form-singwaapp" url="<?php echo url('news/add'); ?>">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <input id="file_upload_image" name="image" type="hidden" multiple="true" value="1">
      </div>
    </div>
